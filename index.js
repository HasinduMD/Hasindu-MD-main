const {
  ...
  let up = `*ʜᴀꜱɪɴᴅᴜ ᴍᴅ ʙᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ ✅*\n\n*ᴘʀᴇꜰɪx:* ${prefix}`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/kVD2Ddcd/Golden-Queen-MD-VIMAMODS-6r4acawr.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const ikratos = ('94786173599', '94786173599', '94786173599');
 ...
 if(senderNumber.includes("94718720900")){
  if(isReact) return
  m.react("🖤")
  }
